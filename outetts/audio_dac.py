...
class DacInterface:
    def __init__(self, dac_model, device):
        self.device = device
        self.model = dac_model
        self.sr = 24000
    ...
    @torch.no_grad()
    def encode(self, x: torch.Tensor, win_duration: int = 5, verbose: bool = False):
        ...
        for i in range_fn(0, nt, hop):
            ...
            audio_data = chunk.to(self.device)
    ...
    def decode(
        ...
        for i in range_fn(0, codes.shape[-1], chunk_length):
            ...
            z = self.model.quantizer.from_codes(c)[0]
